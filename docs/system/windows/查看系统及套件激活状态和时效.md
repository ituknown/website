...
<img alt="windows_activation_status.png" src="https://media.ituknown.org/windows-media/activation_status/windows_activation_status.png" />

## 查看 Office 激活状态

步骤及效果如下图（其中黄色标记的是 Office19 对应的 SKU ID）：

![office19_activation_status.png](https://media.ituknown.org/windows-media/activation_status/office19_activation_status.png)
