...
$1.$ **可移植性**：不同系统上的解释器路径可能不同，使用 `env` 可以在多个系统上工作，只要解释器在环境变量中可用。<br/>
$2.$ **灵活性**：脚本作者不需要关心用户系统上解释器的确切路径，只需假设用户已正确安装了所需的解释器。<br/>
$3.$ **维护性**：如果用户想要切换到不同版本的解释器，他们只需更新环境变量中的路径，而无需修改脚本文件。<br/>
