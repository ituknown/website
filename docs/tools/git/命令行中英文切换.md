...
<img src="https://media.ituknown.org/git-media/LANG/git-status-chinese.png" alt="git-status-chinese.png" width="500px" />
...
<img src="https://media.ituknown.org/git-media/LANG/git-status-english.png" alt="git-status-english.png" width="500" />
